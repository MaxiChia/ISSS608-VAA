...
### 3.4 Transforming the Data Frame into a Matrix
...
## Normalised Matrix Column-wise (Scaled cex size)
...
Three main data transformation methods are supported by *heatmaply()*, namely: - **scale** - **normalise** - **percentilse**
