...
There are three broad reasons for computing a correlation matri:
...
::: panel-tabset
## Static Correlation Plot with Columns 1 - 11
...
## Static Correlation Plot with Columns 2 - 12
...
::: panel-tabset
## Lower Half of the Correlation Plot

To show the lower half of the correlation matrix, the *upper.panel() = NULL* argument will be used as shown in the code chunk below.
...
## Upper Half of the Correlation Plot

Similarly, you can display the upper half of the correlation matrix, the *lower.panel() = NULL* argument will be used as shown code chunk below.
...
## Basic Correlation with Customisation
...
My package of ggplot2 is newer - ver 4.0.3. This latest version the version of ggtern package is not compatible to the latest version of ggplot 2. Instead of redownloading the version 3.2.1 of ggplot2, i remained the latest version ad tried to adjust the plot width and height to fit the words within the plot by adding the markdown \n #\| fig-width: 12 \n #\| fig-height: 7
:::
...
Next, we will focus on `corrplot`. However, you are encouraged to explore the other two packages too.
...
## Working with *"elipse"* and Arranged in Alphabetical Order

```{r}
#| code-fold: true
corrplot(wine.cor, 
         method = "ellipse", order = "alphabet") 
```

## Working with *"circle"* and Arranged in Alphabetical Order
...
## Working with *"colour"* and Arranged in Alphabetical Order
...
## Working with *"number"* and Arranged in Alphabetical Order
...
## Working with *"pie"* and Arranged in Alphabetical Order

```{r}
#| code-fold: true
corrplot(wine.cor, 
         method = "pie", order = "alphabet") 
```

## Working with *"shade"* and Arranged in Alphabetical Order

```{r}
#| code-fold: true
corrplot(wine.cor, 
         method = "shade", order = "alphabet") 
```
:::
...
## Working with type *"lower"*, *diag* and *tl.col*
...
## Working with type *"lower"* and *tl.cex*

*tl.cex* control the size of the text
...
## Working with type *"lower"*, *tl.cex* and *tl.pos*

*tl.pos* controls the position of the labels.
...
## Working with type *"lower"*, *tl.cex*, *tl.pos*, *tl.offset*, *cl.cex* and *cl.pos*

*tl.offset* moves the labels away from the plot. *cl.cex* controls the legend label text size. *cl.pos* controls the position of the color scale legend
...
::: panel-tabset
## Working with a mixed layout coorgram with *"ellipse"* and *"number"*
...
## Working with a mixed layout coorgram with *"circle"* and *"number"*
...
## Working with a mixed layout coorgram with rotated labels
