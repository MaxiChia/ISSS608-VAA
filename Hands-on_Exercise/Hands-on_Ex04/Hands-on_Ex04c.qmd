...
![](Images/ggdist.png) \## Visualizing the uncertainty of point estimates: ggdist methods - `stat_pointinterval()` In the code chunk below, [stat_pointinterval()](https://mjskay.github.io/ggdist/reference/stat_pointinterval.html) of **ggdist** is used to build a visual for displaying distribution of maths scores by race.
...
#remotes::install_github("wilkelab/ungeviz",dependencies = TRUE)
```
