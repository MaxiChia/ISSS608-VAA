...
::: callout-tip
## Things to learn from the code chunk above
- Added `data_type` argument is used to change from default “SR” to “PR” (i.e. proportions). 
- Added `xrange` and `yrange` are used to set the range of x-axis and y-axis.
:::
